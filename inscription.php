...
<head>
    <meta charset="UTF-8">
    <title>Flagrant Délice - Inscription</title>
...
<body>
    ...
    <div class="header-menu">
        <ul>
            ...
            <li><a href="inscription.php" class="btn-inscription actif">INSCRIPTION</a></li>
        </ul>
    </div>
    ...
    <div class="conteneur-formulaire">
        ...
        <form action="verif/verification_inscription.php" method="post">
            ...
            <fieldset class="groupe-formulaire">
                ...
                <p class="texte-info-preferences">
            ...
            <div class="form-actions">
                <button type="submit" class="btn-recherche btn-submit-form">VALIDER MON INSCRIPTION</button>
                <br><br>
                <a href="connexion.php" class="lien-redirection">Vous avez déjà un compte ? ></a>
            </div>
